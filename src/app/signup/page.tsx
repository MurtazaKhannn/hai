...
const page = () => {
  ...
  return (
    <div className="flex flex-col w-full h-[100vh] items-center justify-center gap-10 text-black">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col justify-center items-center gap-6">
        ...
        value={input.username}
          className="p-2 rounded-md bg-zinc-100 outline-none font-bold"
          type="text"
        ...
        name="email"
        value={input.email}
          className="outline-none p-2 rounded-md bg-zinc-100 font-bold"
          type="email"
          placeholder="Email"
        />
        ...
        <button
          className="font-vina bg-zinc-100 rounded-md w-[6vw] py-2 "
          type="submit"
        >
          Sign Up
        </button>
